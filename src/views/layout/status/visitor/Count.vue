<template>
    <div>
        ...
        <!-- Dialog -->
        <el-dialog :title="'学校流量统计' + '（ ' + timeRangeText + ' ）'"
            ...
            <el-table :data="tableData"
                ...
                <el-table-column type="expand">
                    <template slot-scope="props">
                        <el-table :data="props.row.details"
                            ...
                            <el-table-column prop="user_country_suffix" label="所属国家" min-width="100"></el-table-column>
                ...
                <el-table-column prop="domain_name" label="域名" min-width="120"></el-table-column>
                <el-table-column label="总流量" min-width="120">
                    <template slot-scope="scope">
                        <span :class="scope.row.total_bytes >= 1073741824 ? 'danger' : ''">
                        {{ tools.formatFlow(scope.row.total_bytes,'b') }}
    ...
    export default {
        ...
        data() {
            return {
                ...
                tableData: [],
                // 请求接口
                api: this.config.api.status.visitor.count
            }
        },
        methods: {
            // 获取当前日期
            ...
            getData() {
                ...
                request.get(url, para, res => {
                    ...
                    this.chartData = this.totalData.chart;
                    this.tableData = this.totalData.table;
                    // 关闭 loading 状态
